...
public class TEVDummy {
	public static void main(String[] args) throws IOException {
		ArrayList<TEVinfo> list = new ArrayList<TEVinfo>();//중복검사용
		...
		//색상,형태 등..
		String[] color = {"화이트", "블랙",};
		String[] door = {"LED", "OLED", "QLED"};
		String[] door2 = {"8K UHD", "4K UHD", "FHD"};
		
		//더미데이터 파일 불러오기
		BufferedWriter writer = new BufferedWriter(new FileWriter("DummyData\\TEVinfo.txt"));
		BufferedWriter writer2 = new BufferedWriter(new FileWriter("DummyData\\TEVmanage.txt"));
		
		//50개 생성
		for (int i=1; i<=50; i++) {
			//관리번호
			String itemCode = "TEV_20230814_" + i;
			//카테고리
			String category = "TV";
			//기업명
			...
			//L
			String volume = (rnd.nextInt(20)+20)*2+"인치";
			//제품명
			String code = "TEV";
			//중간 숫자 5개 생성
			for (int j = 0; j < 5; j++) {
			...
			TEVinfo ri = new TEVinfo(itemCode, category, ent, name, code, colorChoice, doorChoice, doorChoice2, volume);
			list.add(ri);
			//추가
